...
<style type='text/css'>
	...
	.Table_Data_chintan_web_Content_2 { position:relative; width:99%; }
	.Table_Data_chintan_web1_2 { position:absolute; top:0%; left:0%; width:100% !important; margin-top:10px; z-index:1; }
	.chintan_web_Tit_Table_2 { width: 100%; background-color: #fff; text-align: center; text-shadow:1px 1px 1px #000000; padding: 1px; color: #fff; }
	.chintan_web_Tit_Table_2_Tr { background:#30a9d1; }
	.chintan_web_Tit_Table_2 td:nth-child(1) { width:10%; }
	.chintan_web_Tit_Table_2 td:nth-child(2) { width:30%; }
	.chintan_web_Tit_Table_2 td:nth-child(3) { width:30%; }
	.chintan_web_Tit_Table_2 td:nth-child(4) { width:10%; }
	.chintan_web_Tit_Table_2 td:nth-child(5) { width:10%; }
	.chintan_web_Tit_Table_2 td:nth-child(6) { width:10%; }
	.chintan_web_Tit_Table2_2 { width: 100%; background-color: #fff; margin-top:10px; text-align: center; text-shadow:0px 0px 0px #000000; padding: 1px; color: #34383c; margin-bottom: 100px; }
	.chintan_web_Tit_Table2_2_Tr2 { background:#f1f1f1; }
	.chintan_web_Tit_Table2_2_Tr2:nth-child(even) { background:#ffffff; }
	.chintan_web_Tit_Table2_2_Tr2:hover { background:#e9e9e9; }
	.chintan_web_Tit_Table2_2 td:nth-child(1) { width:10%; }
	.chintan_web_Tit_Table2_2 td:nth-child(2) { width:30%; }
	.chintan_web_Tit_Table2_2 td:nth-child(3) { width:30%; }
	.chintan_web_Tit_Table2_2 td:nth-child(4) { width:10%; cursor:pointer; }
	.chintan_web_Tit_Table2_2 td:nth-child(5) { width:10%; cursor:pointer; }
	.chintan_web_Tit_Table2_2 td:nth-child(6) { width:10%; cursor:pointer; }
	...
	.Table_Data_chintan_web2_2 { position:absolute; top:0%; left:0%; width:100% !important; margin-top:10px; z-index:1; display:none; }
	.chintan_web_SaveSl_Table, .chintan_web_SaveSl_Table_2 { position:relative; width: 100%; padding: 1px; background-color: #fff; text-align: center; color: #000; font-size: 12px; margin-bottom:15px; }
	.chintan_web_SaveSl_Table_2 tr, .chintan_web_SaveSl_Table tr { background:#f1f1f1; height: 35px; }
	.chintan_web_SaveSl_Table_2 tr:nth-child(even), .chintan_web_SaveSl_Table tr:nth-child(even) { background:#ffffff; }
	.chintan_web_SaveSl_Table_2 tr td { width: 25%; }
	.chintan_web_SaveSl_Table tr td, .chintan_web_Text_Field { width: 50%; }
	.chintan_web_Select_Menu { width: 70%; }
